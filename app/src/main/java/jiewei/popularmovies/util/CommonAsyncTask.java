package jiewei.popularmovies.util;
...
import jiewei.popularmovies.BuildConfig;
import jiewei.popularmovies.PopularMovieFragment;
import jiewei.popularmovies.ReviewFragment;
import jiewei.popularmovies.TopRatedMovieFragment;
import jiewei.popularmovies.TrailerFragment;
...
/**
 * Created by Jie Wei on 01/12/2016.
 */
    ...
    protected Object doInBackground(String... strings) {
        ...
        if (request_type == Constants.MOST_POPULAR_REQUEST) {
            ...
            builder = Uri.parse(Constants.REQUEST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter("api_key", BuildConfig.MOVIE_DATABASE_API_KEY)
                    .appendQueryParameter("vote_count.gte", BuildConfig.VOTE_COUNT)
                    .appendQueryParameter("page", page)
        ...
        protected void onPostExecute (Object object){
            ...
            ((ReviewFragment)fragment).onTaskCompleted(object);
        }
